...
public class GsonPerfTestWithCustomReader {

    private static String json;
    private static int n = 40;
    private static String [] requiredElements = new String[]{"//id", "//menu/meta/calories", "//status", "//menu/address"};
//    private static String [] requiredElements = null;
    
    public static void main(String[] args) throws Exception {
        Options opt = new OptionsBuilder()
                .include(GsonPerfTestWithCustomReader.class.getSimpleName())
                .warmupIterations(10)
